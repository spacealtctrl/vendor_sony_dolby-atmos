...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_AUDIO)/proprietary/system_ext/etc/permissions/privapp-permissions-musicfx.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-musicfx.xml \
